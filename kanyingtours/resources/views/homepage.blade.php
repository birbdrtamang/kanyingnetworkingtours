...
<body>
        ...
        <div class="container pb-5" >
            <div class="bg-light shadow" style="padding: 30px;">
                <div class="row" style="min-height: 60px;">
                    <form class="max-w-sm mx-auto" action="{{route('bookTravel')}}" method="POST">
                    <h6 class="text-primary text-upercase" style="letter-spacing: 5px; text-align:center;margin-bottom:20px">Book Travel Now</h6>
                        @csrf
                        <div class="form-group">
                            <input style="width:100%" name="name" type="text" id="name" class="form-control" placeholder="Fullname" required />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 8)" maxlength="8" name="contact" type="number" id="contact"  class="form-control" placeholder="Contact No." required />
                        </div>
                        <div class="form-group">
    ...
    <a href="https://wa.link/eg415m" class="btn btn-lg btn-primary btn-lg-square whatsapp"><i class="fab fa-whatsapp"></i></a>
